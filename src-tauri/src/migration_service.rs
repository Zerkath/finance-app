...
pub fn init_db_with_data(db: &Connection) -> Result<(), rusqlite::Error> {
    let data = vec![
        ...
        (20.0, "test6", Some("test6"), "2023-11-06", vec![1, 2, 3]),
        (30.0, "test7", Some("test7"), "2023-11-07", vec![1, 2, 3]),
        (-5.0, "test8", Some("test8"), "2023-11-08", vec![1, 2, 3]),
        (10.0, "test9", Some("test9"), "2023-11-09", vec![1, 2, 3]),
        (-5.0, "test12", Some("test12"), "2023-11-12", vec![1, 2, 3]),
        (-10.0, "test13", Some("test13"), "2023-11-13", vec![1, 2, 3]),
        (-20.0, "test14", Some("test14"), "2023-11-14", vec![1, 2, 3]),
        (-30.0, "test15", Some("test15"), "2023-11-15", vec![1]),
        (-5.0, "test16", Some("test16"), "2023-11-16", vec![1, 2, 3]),
        (10.0, "test17", Some("test17"), "2023-11-17", vec![1, 2, 3]),
        (20.0, "test18", Some("test18"), "2023-11-18", vec![1, 2, 3]),
        (30.0, "test19", Some("test19"), "2023-11-19", vec![1, 2, 3]),
        (-5.0, "test20", Some("test20"), "2023-11-20", vec![1, 2, 3]),
        (-10.0, "test21", Some("test21"), "2023-11-21", vec![1, 2, 3]),
        (-20.0, "test22", Some("test22"), "2023-11-22", vec![1, 2, 3]),
